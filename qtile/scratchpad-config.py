...
keys = [
        ...
        #=-/ Terminals /-=#
        Key([mod], "Return", lazy.spawn("terminator -e fish"), desc='Run Launcher'),
        ...
        #=-/ Browsers /-=#
        Key([mod], "w", lazy.spawn("chromium"), desc='chromium-browser'),
...
widget_defaults = dict(
    font="Terminus Bold",  ### NERD FONT https://www.nerdfonts.com/font-downloads
    fontsize = 10,
    padding = 2,
    background="#1f233588"
)
